...
from web_server.layers.device_handle_layer import node_device
from web_server.layers.service import node_service
from web_server.layers.deal_convert_layer import node_deal_convert
from web_server.layers.device_info_layer import node_device_info
...
app.register_blueprint(node_device_info, url_prefix='/device_info')
