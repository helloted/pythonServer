...
ERROR_NO_Such_File = AppError(code=134, msg='No such file')
ERROR_NO_Such_Values = AppError(code=135, msg='No such values')
ERROR_NO_Enough_Code = AppError(code=136, msg='Not enough code')
ERROR_Wrong_SN = AppError(code=137, msg='StartSN or EndSn Wrong')