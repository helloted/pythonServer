...
def upload_deal():
    while True:
        ...
        deal_sn =  '6201001000100' + str(now_msec)
        data2 = {"cmd": "upload_deal",
                 "seq": 3,
                 "version": 2,
                 'content': {'deal_sn':deal_sn,'content':'this is the content'}
                 }
